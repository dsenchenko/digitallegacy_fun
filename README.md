...
| Головна | http://localhost:5173/ | Соцмережі та опис |
| Меню для глядачів | http://localhost:5173/menu | Список усіх нагород та цін |
| Розіграші | http://localhost:5173/giveaways | Публічний список розіграшів |
| Віджет OBS | унікальний URL з адмін-панелі | Оверлей для джерела браузера в OBS |

## Налаштування OBS

1. У OBS додайте **Джерело браузера**
2. Скопіюйте **URL віджета OBS** з адмін-панелі (формат: `/widgets/ваш-унікальний-токен`)
...
- **Головна:** `https://YOUR_DOMAIN/`
- **Меню:** `https://YOUR_DOMAIN/menu`
- **Розіграші:** `https://YOUR_DOMAIN/giveaways`
- **Віджет:** скопіюйте URL з адмін-панелі (`/widgets/...`)
